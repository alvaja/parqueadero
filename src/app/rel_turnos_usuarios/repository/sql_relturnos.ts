export const SQL_RELTURNO = {
    FIND_ALL:
      "SELECT r.cod_turnousuario, r.cod_turno, r.cod_usuario \
    FROM rel_turno_usuario r ORDER BY r.cod_turnousuario",
  
    FIND_BY_ID:
      "SELECT  r.cod_turnousuario, r.nombre_rol FROM rel_turno_usuario r \
    WHERE  r.cod_turno = $1",
  
    HOW_MANY:
      "SELECT COUNT(r.cod_turnousuario) as cantidad FROM rel_turno_usuario r  \
    WHERE r.cod_turno = $1",
