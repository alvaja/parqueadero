...
import {
  datosRelTurnosActualizar,
  datosRelTurnosBorrar,
  datosRelTurnosCrear,
} from "../../../config/domain/ValidarRelTurnos";
...
class RutaRelTurno {
  ...
  constructor() {
    ...
    this.rutaRelTurnoApi.get(
        "/getall",
        controladorRelTurnosConsulta.llamarObtenerTodos
      );
    this.rutaRelTurnoApi.post(
      "/add",
      datosRelTurnosCrear,
      validarDatos.ahora,
      controladorRelTurnosCrear.llamarGrabarRelTurnos
    );    
    this.rutaRelTurnoApi.delete(
      "/delete/:codTurnoUsuario",
      datosRelTurnosBorrar,
      validarDatos.ahora,
      controladorRelTurnosBorrar.llamarBorrar
    );
    this.rutaRelTurnoApi.put(
      "/update",
      datosRelTurnosActualizar,
      validarDatos.ahora,
      controladorRelTurnosActualizar.llamarActualizarRelTurnos
    );
  }
}
