...
import { datosTurnoActualizar, datosTurnoBorrar, datosTurnoCrear } from "../../../config/domain/ValidarTurno";
...
class RutaTurno{
    ...
    constructor(){
        ...
        this.rutaTurnoApi.put("/update", datosTurnoActualizar, validarDatos.ahora, controladorTurnoActualizar.llamarActualizarTurno);
    }
